/**
 * Home page using new DataService architecture
 * This is a migration of the original Home.tsx
 * 
 * Changes:
 * - Uses LiveMatchCardNew which uses the new useLiveGames hook
...
import LiveMatchCardNew from '../features/normal-game/components/LiveMatchCardNew';
    ...
    <IonPage>
      <IonContent fullscreen>
        ...
        <div style={{
          ...
          {/* Live Games Section - Now using new DataService */}
